...
*   **Exportation des Résultats :** Génération automatique d'un fichier texte formaté dans le dossier `Documents/ChronoRegateComite` pour une transmission rapide des résultats.
